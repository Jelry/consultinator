			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Main -->
					<div id="main">
					  ...
					  <p style="color:grey;margin-bottom:1.5em;">This is where requests for consultation are displayed.  You can view the details, accept the request, or deny it. </p>
						<section class="posts">

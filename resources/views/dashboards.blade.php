...
<html>
	<head>
		<title>{{$LoggedUserInfo['name']}}'s Lair</title>
		<meta charset="utf-8" />
			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Main -->
					<div id="main">
						...
						{{-- <p style="color:grey;">   This is where the students request for consultation are displayed.  You can view the details, accept the request, or deny it.</p>
					 --}}
					 <p style="color:grey;margin-bottom:1.5em;">This is where the available schedule of instructors are displayed. Request ka ng consultation by clicking that button over there.</p>
